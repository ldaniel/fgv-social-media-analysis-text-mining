...
As plataformas de descoberta de novos conteúdos que tender a ir de acordo com o gosto musical do público tem se tornado um dos principais ativos de diferenciação das plataformas de distribuição de música.
test
Existem diversas formas de se construir sistemas de recomendação, a maior parte deles baseada no histórico de streaming dos usuários.

Pensamos em uma alternativa diferente, que pode até não ser eficiente quanto a técnicas de machine learning aplicadas no comportamento do público, mas que pode despertar a curiosidade dos fãs de música.
...
Para esta tarefa iremos utilizar um dataset extraído do [Kaggle](https://www.kaggle.com/gyani95/380000-lyrics-from-metrolyrics).

Existe cerca de 380 mil letras de música neste dataset de uma variedade de artistas e gêneros.

Retirando todas as inconsistências e aplicando os seguintes filtros no dataset:
...
Ficamos com cerca de 237 mil letras de músicas que utilizaremos para analisar diversos aspectos utilizando técnicas de mineração de texto and análise de rede tais como:

- Identificar as palavras e bigramas que são mais utilizadas por artista, gênero e década.

- Analisar a correlação das letras de diferentes artistas e montar um grafo identificando as possíveis influências entre os artistas e gêneros.
...
Iremos desenvolver a prova de conceito utilizando o dataset mencionado nas sessões anteriores com entregável da segunda parte desta disciplina ao professor Gustavo Mirapalheta.
...
- [**Kaggle - 380,000+ lyrics from MetroLyrics**](https://www.kaggle.com/gyani95/380000-lyrics-from-metrolyrics) --Mansoor Iqbal
